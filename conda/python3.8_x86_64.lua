local help_message = [[
The python 3.8 x86_64 Anaconda python environment.
...
whatis("Name: Anaconda Python 3.8 x86_64")
whatis("Version: 4.10.3-3.8")
whatis("Category: python conda")
whatis("Keywords: python conda")
whatis("Description: Python 3.8 x86_64 Anaconda python environment")
